                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="user-lankah_langkah_pendaftaran-records">
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-password"> <?php echo $data['password']; ?></td>
                                                    <td class="td-foto">
                                                    ...
                                                    <td class="td-user_role_id">
                                                        <span <?php if($can_edit){ ?> data-source='<?php print_link('api/json/user_user_role_id_option_list'); ?>' 
