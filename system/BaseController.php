...
class BaseController{
	...
	function __construct(){
		...
		$this->file_upload_settings['bukti_pembayaran'] = array(
			"title" => "{{random}}",
			"extensions" => "",
			"limit" => "1",
			"filesize" => "3",
		...
		$this->file_upload_settings['logo'] = array(
			"title" => "{{random}}",
			"extensions" => "",
			"limit" => "1",
			"filesize" => "3",
		...
		$this->file_upload_settings['foto_tempat_kursus'] = array(
			"title" => "{{random}}",
			"extensions" => "",
			"limit" => "1",
			"filesize" => "3",
		...
		$this->file_upload_settings['alur_pendaftaran'] = array(
			"title" => "{{random}}",
			"extensions" => "",
			"limit" => "1",
			"filesize" => "3",
